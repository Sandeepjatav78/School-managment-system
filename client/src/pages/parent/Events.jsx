  ...
  return (
    <>
      <div className="page-header">
        <div>
          <h1>Events</h1>
          <p>School functions, activities and holidays.</p>
        </div>
      </div>
      ...
      <div className="grid-stats">
        ...
        <StatCard icon={Palmtree} tone="amber" value={list.filter((e) => e.isHoliday).length} label="Holidays ahead" sub="Plan ahead" />
      </div>
