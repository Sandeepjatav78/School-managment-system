...
export default function Leaves() {
  ...
  const apply = async () => {
    ...
    try {
      ...
      showToast(`Leave applied — ${r.data.days} day(s), awaiting approval`);
      setModal(false);
    ...
    <>
      <div className="page-header">
        <div>
          ...
          <p>Apply for leave — your parents and the school will be notified.</p>
        </div>
      ...
      <div className="grid-stats">
        <StatCard icon={CalendarClock} tone="indigo" value={balance.length ? balance.reduce((s, b) => s + b.remaining, 0) : '—'} label="Days remaining" sub="Across all leave types" />
          ...
          <table className="table">
            ...
            <tbody>
              ...
              {data.list.length === 0 && (
                <tr>
                  <td colSpan={7}>
                    <div className="empty"><p>No leaves applied yet.</p></div>
                  </td>
                </tr>
              )}
            </tbody>
